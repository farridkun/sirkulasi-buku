...
/* Smarty version 3.1.31, created on 2020-01-26 16:25:09
  from "C:\xampp\htdocs\latihan\libray-cms\private\Templates\admin\issues\userIssuedBooks-list.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_5e2daf5576c6a0_82239176',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f44e43e8f0a7ba2b246dd1f85bdaccb3e824db32' => 
    array (
      0 => 'C:\\xampp\\htdocs\\latihan\\libray-cms\\private\\Templates\\admin\\issues\\userIssuedBooks-list.tpl',
      1 => 1519033206,
      2 => 'file',
    ),
  ),
...
function content_5e2daf5576c6a0_82239176 (Smarty_Internal_Template $_smarty_tpl) {
...
<div class="card-header">
    <div class="heading-elements">
        <select name="sortColumn" id="books-sort" class="select-picker <?php if ($_smarty_tpl->tpl_vars['activeLanguage']->value->isRTL()) {?>pl-2<?php } else { ?>pr-2<?php }?> d-tc" autocomplete="off">
...
" class="<?php if ($_smarty_tpl->tpl_vars['activeLanguage']->value->isRTL()) {?>mr-1<?php } else { ?>ml-1<?php }?>"><i class="fa fa-download" aria-hidden="true"></i> <?php $_smarty_tpl->smarty->_cache['_tag_stack'][] = array('t', array());
$_block_repeat=true;
echo smarty_block_t(array(), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
...
" class="<?php if ($_smarty_tpl->tpl_vars['activeLanguage']->value->isRTL()) {?>mr-1<?php } else { ?>ml-1<?php }?>"><i class="fa fa-eye" aria-hidden="true"></i> <?php $_smarty_tpl->smarty->_cache['_tag_stack'][] = array('t', array());
$_block_repeat=true;
echo smarty_block_t(array(), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
